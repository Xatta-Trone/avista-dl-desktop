    ...
    lines = [
        ...
        _markdown_pairs(
            [
                ...
                ("AVISTA release date", summary["release_date"]),
            ]
        ),
        "",
        "## Dataset Summary",
...
def _pdf_footer(figure, page_number: int) -> None:
    figure.text(
        ...
        0.025,
        (
            f"Generated by {APP_NAME} | Version {__version__} | "
            f"Release date {RELEASE_DATE} | Page {page_number}"
        ),
        ha="center",
        fontsize=8,
        color="#5B6573",
